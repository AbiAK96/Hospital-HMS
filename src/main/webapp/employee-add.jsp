                                   ...
                                   <form action="Employee?action=add" method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <input type ="hidden" name="action" value="add"/>
                                                <label>Name</label>
                                                <input name ="employeeName" type="text" class="form-control" placeholder="name" required>
                                            </div>
                                                <div class="form-group col-md-6">
                                                <label>Address</label>
                                                <input name ="employeeAddress" type="text" class="form-control" placeholder="address" required>
                                            </div>
                                                <div class="form-group col-md-6">
                                                <label>Email</label>
                                                <input name ="employeeEmail" type="text" class="form-control" placeholder="email" required>
                                            </div>
                                                <div class="form-group col-md-6">
                                                <label>Contact</label>
                                                <input name ="employeeTel" type="text" class="form-control" placeholder="+94" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Select Role</label>
                                                <br>
												<select id="roleId" name="roleId" class="btn btn-success dropdown-toggle" required>
													<tag:forEach items="${roleList}" var="role">
                                    ...
                                    <br><br><br>
                                    <button type="submit" class="btn btn-success">Add Employe</button>
                                    </form>
