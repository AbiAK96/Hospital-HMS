                                ...
                                <div class="basic-form">
                                    <form action="Branch" method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label>Address</label>
                                                <input type="text" name ="branchAddress" class="form-control" placeholder="Address" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Email</label>
                                                <input type="Email" name ="branchEmail" class="form-control" placeholder="branch@gmail.com" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Contact</label>
                                                <input type="text" name ="branchTel" class="form-control" placeholder="+94" required>
                                            </div>
                                        </div>
