            ...
            <div class="container-fluid">
                            ...
                            <div class="card-header">
                                ...
                                <div class="form-group col-md-6">
                                 ...
                                 <form action="Branch">
                                 <input name="branchId" type="text" class="form-control" placeholder="Branch ID" required >
                                 <br>
                                 <button type="submit" class="btn btn-success">Search branch</button>
                                 </form>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="Branch?action=update" method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label>Address</label>
                                                <input type="text" class="form-control" name="branchAddress" value ="${branch.branchAddress}" required/>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Email</label>
                                                <input type="Email" class="form-control" name="branchEmail" value ="${branch.branchEmail}" required/>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Contact</label>
                                                <input type="text" class="form-control" name="branchTel" value ="${branch.branchTel}" required/>
                                            </div>
                                        </div>
