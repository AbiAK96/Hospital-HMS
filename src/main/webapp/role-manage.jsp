            ...
            <div class="container-fluid">
                            ...
                            <div class="card-header">
                                ...
                                <div class="form-group col-md-6">
                                 ...
                                 <form action="Role">
                                 <input name="roleId" type="text" class="form-control" placeholder="Role ID" >
                                 <br>
                                 <button type="submit" class="btn btn-primary">Search role</button>
                                 </form>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="basic-form">
									<form action="updateRole?action=update" method="post">
                                        <div class="form-row">
                                        	 <div class="form-group col-md-6">
                                                <label>Role ID</label>
                                                <input type="text" class="form-control" name="roleId" value ="${role.roleId}"/>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label> Name</label>
