                                    ...
                                    <form action="Medicine" method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name ="medicineDescription" class="form-control" placeholder="Description" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Manufacturing Date</label>
                                                <input type="text" name ="manufacturingDate" class="form-control" placeholder="Manufacturing date" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Expiry Date</label>
                                                <input type="text" name ="expiryDate" class="form-control" placeholder="expiryDate" required>
                                            </div>
                                        </div>
