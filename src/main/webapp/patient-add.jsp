						...
						<div class="basic-form">
							<form action="Patient?action=add" method="post">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>Patient NIC</label> <input type="text"
											name="patientNIC" class="form-control"
											placeholder="Patient NIC" required>
									</div>
									<div class="form-group col-md-6">
										<label>Patient Age</label> <input type="text"
											name="patientAge" class="form-control"
											placeholder="Patient Age" required>
									</div>
									<div class="form-group col-md-6">
										<label>Patient Gender</label> <select id="patientGender"
											name="patientGender" class="form-control">
									...
									<div class="form-group col-md-6">
										<label>Patient Address</label> <input type="text"
											name="patientAddress" class="form-control"
											placeholder="Patient Address" required>
									</div>
									<div class="form-group col-md-6">
										<label>Patient Contact</label> <input type="text"
											name="patientTel" class="form-control"
											placeholder="Patient Contact" required>
									</div>
									<input type="hidden" name="patientStatus" class="form-control" placeholder="dischargeDate" value="Admit">
									<div class="form-group col-md-6">
										<label>Admit-Date</label> <input name="admitDate"
											class="datepicker-default form-control" value="Select date"
											id="admitDate" required>
									</div>
										 <input type="hidden" name="dischargeDate" class="form-control" placeholder="dischargeDate" value="-">

									<div class="form-group col-md-6">
										<label>Branch</label> <br> <select id="branchId"
											name="branchId" class="btn btn-success dropdown-toggle">
									...
									<div class="form-group col-md-6">
										<label>Doctor</label> <br> <select id="doctorId"
											name="doctorId" class="btn btn-success dropdown-toggle">
									...
									<div class="form-group col-md-6">
										<label>Ward</label> <br> <select id="wardId"
											name="wardId" class="btn btn-success dropdown-toggle">
