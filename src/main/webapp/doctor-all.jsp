                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Action</th>
                                        			...
                                        			<tbody>
				<tag:forEach var="doctorDetail" items="${doctorDetailList}">
					<tr>
						<td>${doctorDetail.doctorId}</td>
						<td>${doctorDetail.employeeId}</td>
						<td>${doctorDetail.specialist}</td>
						<td>
						<form action="DoctorDetail" method="post">
							<input type="hidden" name="action" value="delete">
							<input type="hidden" name="doctorId" value="${doctorDetail.doctorId}">
							<button class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to delete this doctor')">Delete</button>
						</form>
							</td>
								</tr>
				</tag:forEach>
