        ...
        <div class="content-body">
            ...
            <div class="container-fluid">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">Ward Form</h4>
                            </div>
                            <div class="card-body">
                                    ...
                                    <form action="Ward" method="post">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <input type ="hidden" name="action" value="add"/>
                                              <label for="wardType">Enter the ward Type:</label>
											<input id="wardType" type="text" name ="wardType" class="form-control" placeholder="Enter ward Type over here!" required/>
											</div>
											<br>
