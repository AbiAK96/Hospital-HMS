                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">All tranfer details</h4>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="example2" class="display" style="width:100%">
						               ...
						               <tbody style="color: black;">
										<tag:forEach var="transfer" items="${transferList}">
											<tr>
												<td>${transfer.transferId}</td>
												<td>${transfer.patientName}</td>
												<td>${transfer.branchId}</td>
												...
												<form action="Transfer" method="post">
													...
													<button class="btn btn-danger" type="submit" onclick="return confirm('Are you sure you want to delete this transfer')">Delete</button>
												</form>
												</td>
											</tr>
										</tag:forEach>
